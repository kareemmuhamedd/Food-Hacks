...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> textsEn = {
    ...
    "steps-m9": [
      ...
      'Bake in preheated oven until scuffles are puffed and have risEng above the top of the rims, 12 to 15 minutes.',
    ],
    "steps-m10": [
  ...
  changeLang(bool lan) async {
    isEng = lan;
    notifyListeners();
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setBool("isEng", isEng);
  }

  getLang() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    isEng = prefs.getBool("isEng") ?? true;
    notifyListeners();
  }

  Object getTexts(String txt) {
    if (isEng == true) return textsEn[txt]!;
    return textsAr[txt]!;
  }
}
